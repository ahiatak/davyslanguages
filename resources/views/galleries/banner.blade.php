                            ...
                            <div id="sc_layouts_title_675796043" class="sc_layouts_title sc_align_center with_content">
                                <div class="sc_layouts_title_content">
                                    ...
                                    <div class="sc_layouts_title_breadcrumbs">
                                        <div class="breadcrumbs"><a class="breadcrumbs_item home" href="http://prolingua.themerex.net/">{{ $texts->where('id', 1)->first()->text }}</a><span class="breadcrumbs_delimiter"></span><span class="breadcrumbs_item current">{{ $texts->where('id', 2)->first()->text }}</span></div>
                                    </div>
                                </div>
