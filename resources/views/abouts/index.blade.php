...
<style type="text/css" data-type="vc_shortcodes-custom-css">
        .vc_custom_1509364425606 {
            ...
            background-image: url(http:wp-content/uploads/2017/08/image-25.jpg?id=253);
...
@section('content')
    ...
    @php $title = $texts->where('id', 2)->first()->text . " Cours  d'Anglais à Lomé - Togo | Tarif " @endphp
