            ...
            <div class="chatpopup-support-persons">
                <div class="chatpopup-support-person">
                    <div class="chatpopup-support-person__img">
                        <img src="https://davyslanguages.com/img/call.png" alt="//">
                    </div>
                    <div class="chatpopup-support-person__meta">
                        <div class="chatpopup-support-person__name">Rosaline Clark</div>
                        <div class="chatpopup-support-person__title">Assistante</div>
                    </div>
                </div>
            </div>
            <div class="chatpopup-input-wrapper">
                <span class="chatpopup-blinking-cursor" style="display: none;">|</span>
                <input type="text" id="chatpopup-type-and-chat-input" placeholder="😀 Salut, que puis-je pour vous ?" name="message_to_send">
                <div class="chatpopup-input-icon">
                    <img src="https://davyslanguages.com/img/call.png" width="30" alt="//">
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        var message = "";
        var number = "22891906112";
        

        function whatsAppApi(number, message = ""){
    	...
    	function sendMessage() {
    		message = $("input[name=message_to_send]").val();
    		...
    		url = whatsAppApi(number, message);
        ...
        $('.chatpopup-support-person').on('click', function (event) {
            event.preventDefault();
            message = $("input[name=message_to_send]").val();
            url = whatsAppApi(number, message);
            window.open(url, '_blank');
