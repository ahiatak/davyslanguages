    ...
    <div class="wpb_column vc_column_container vc_col-sm-12 sc_layouts_column_icons_position_left">
        <div class="vc_column-inner">
            <div class="wpb_wrapper">
                ...
                <div id="sc_content_439544897" class="sc_content color_style_default sc_content_default sc_content_width_1_1 sc_float_center">
                        ...
                        <div class="sc_layouts_item">
                            <div class="sc_layouts_title_content">
                                ...
                                <div class="sc_layouts_title_breadcrumbs">
                                    <div class="breadcrumbs"><a class="breadcrumbs_item home" href="/">{{ $texts->where('id', 1)->first()->text }}</a><span class="breadcrumbs_delimiter"></span><span class="breadcrumbs_item current">{{ (isset($post))? $post->getTranslatedAttribute('title', $langue, 'fr') :  $texts->where('id', 57)->first()->text }}</span></div>
                                </div>
                            </div>
                            <!-- /.sc_layouts_title -->
                        </div>
