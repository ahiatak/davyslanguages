@php
    $videoImage = $images->where('id', 14)->first();
@endphp
                    ...
                    <div class="wpb_wrapper">
                        ...
                        <div id="widget_video_1890919835" class="widget_area sc_widget_video vc_widget_video wpb_content_element">
                            <aside id="widget_video_1890919835_widget" class="widget widget_video">
                                <div id="sc_video_1369300323" class="trx_addons_video_player with_cover hover_play"><img src="{{Voyager::image($videoImage->url)}}" style="width:484px; height:273px" alt="">
                                    <div class="video_mask"></div>
                                    <div class="video_hover" data-video="&lt;iframe src=&quot;{{ $texts->where('id', 76)->first()->text }}?color=ffffff&amp;portrait=0&amp;autoplay=1&quot; width=&quot;640&quot; height=&quot;360&quot; frameborder=&quot;0&quot; webkitallowfullscreen mozallowfullscreen allowfullscreen&gt;&lt;/iframe&gt;"></div>
