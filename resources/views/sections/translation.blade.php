                            ...
                            <div class="wpb_wrapper">
                                ...
                                <div id="sc_content_126526634" class="sc_content color_style_default sc_content_default sc_content_width_70p sc_float_center">
                                    <div class="sc_content_container">
                                        ...
                                        <a href="{{ route('contacts.index') }}" id="sc_button_1032593694" class="sc_button color_style_default sc_button_default sc_button_size_normal sc_button_icon_left"><span class="sc_button_text"><span class="sc_button_title">{{ $texts->where('id', 12)->first()->text }}</span></span><!-- /.sc_button_text --></a>
                                        <!-- /.sc_button -->
                                    </div>
                                </div>
                                <!-- /.sc_content -->
